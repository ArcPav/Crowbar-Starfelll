...
#Region "Child Widget Event Handlers"
	...
	Private Sub CloneGameSetupButton_Click(sender As Object, e As EventArgs) Handles CloneGameSetupButton.Click
		...
		cloneGameSetup.GameName = "复制 " + Me.theSelectedGameSetup.GameName
		...
		If TypeOf senderGrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso e.RowIndex >= 0 Then
			...
			If openFileWdw.ShowDialog() = Windows.Forms.DialogResult.OK Then
				...
				Catch ex As IO.PathTooLongException
					MessageBox.Show("你选择的文件或文件夹字数太多了 试着通过把模型文件移到别处或重命名文件夹和文件来缩短它." + vbCrLf + vbCrLf + "Windows生成的错误消息: " + vbCrLf + ex.Message, "你选择的文件或文件夹太长了", MessageBoxButtons.OK)
