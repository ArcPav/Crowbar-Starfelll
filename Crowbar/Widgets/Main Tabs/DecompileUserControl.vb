...
#Region "Child Widget Event Handlers"
	...
	Private Sub BrowseForMdlPathFolderOrFileNameButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BrowseForMdlPathFolderOrFileNameButton.Click
		...
		openFileWdw.Title = "打开要反编译的文件或文件夹"
		...
		openFileWdw.Filter = "源引擎MDL文件 (*.mdl) | *.mdl"
		...
		If openFileWdw.ShowDialog() = Windows.Forms.DialogResult.OK Then
			...
			Try
				If Path.GetFileName(openFileWdw.FileName) = "[选择文件夹].mdl" Then
			...
			Catch ex As IO.PathTooLongException
				MessageBox.Show("你选择的文件或文件夹字符太多了 试着把模型文件移到别处或重命名文件夹和文件来缩短." + vbCrLf + vbCrLf + "Windows生成的错误消息: " + vbCrLf + ex.Message, "你尝试选择的文件或文件夹路径太长", MessageBoxButtons.OK)
